...
<div align="center">
  ...
  <br/><br/>
  <img src="screenshots/dark1.png" alt="文件、视频浏览界面" width="90%" />
  <br/>
  <em>文件、视频预览面板</em>
  <br/><br/>
...
| **编码检测** | 自动识别 UTF-8/GBK/Shift-JIS/Latin-1/UTF-16，非 UTF-8 文件正确显示 |
...
| **重命名** | 智能选中（不含扩展名），冲突检测 |
| **压缩/解压** | ZIP 压缩（带进度 + 智能默认文件名），ZIP/TAR/GZ/7z/RAR 解压（ZipSlip 防护）|
| **收藏夹** | 一键添加/移除，持久化存储 |
...
| 文本编码 | 自动检测 UTF-8/GBK/Shift-JIS/Latin-1/UTF-16 |
...
- 🔤 **编码检测** — 自动识别 GBK/Shift-JIS/UTF-16 等非 UTF-8 文本文件，中文批处理正确预览
- 📦 **压缩智能命名** — 单选按文件名、多选按父目录名作为默认 ZIP 文件名
- 📋 **右键菜单优化** — Esc 关闭 / 独立图标 / Paste 无内容禁用态 / 空白区域清除选中
- 🔀 **多选增强** — Shift+Click 范围选择 / 列视图多选 / anchorIndex 修正 / Extract 多选检测
