...
const extMap: Record<string, keyof typeof icons> = {
  ...
  py: "code", rs: "code", go: "code", java: "code", scala: "code", kt: "code",
  c: "code", cpp: "code", cc: "code", cxx: "code", cs: "code", csx: "code",
  h: "code", hpp: "code", hxx: "code", rb: "code", swift: "code", dart: "code",
  php: "code", sh: "code", bash: "code", bat: "code", ps1: "code",
  sql: "code", lua: "code", perl: "code", pl: "code",
  erl: "code", ex: "code", exs: "code", hs: "code", nim: "code", zig: "code",
  fs: "code", fsx: "code", vb: "code",
...
export function getFileIconSvg(extension: string, _isDir: boolean): string | null {
