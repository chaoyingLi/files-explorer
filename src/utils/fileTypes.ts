...
const CATEGORY_MAP: Record<FileCategory, string[]> = {
  folder: [],
  code: [
    "js", "ts", "jsx", "tsx", "vue", "py", "rs", "go", "java", "c", "cpp", "h",
    "rb", "swift", "kt", "scala", "php", "lua", "r", "sh", "bash",
  ],
  ...
  web: ["html", "css", "scss", "less", "sass", "xml", "json", "yaml", "yml", "toml"],
  default: [],
};

export function getFileCategory(extension: string, isDir: boolean): FileCategory {
